...
$customer_id   = isset($in['customer_id']) && $in['customer_id'] !== "" ? (int)$in['customer_id'] : null;
...
/**
 * Si nos mandan customer_id => devolver SOLO ese registro
 */
if ($customer_id !== null) {
  $sql = "SELECT id,
                 organization_id,
...
/**
 * Si NO mandan customer_id => lista filtrada
 */
$sql = "SELECT id,
               organization_id,
               customer_name,
